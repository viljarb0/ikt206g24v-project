...
def write_note_into_db(id, note_to_write):
    with sqlite3.connect(note_db_file_location) as _conn:
        ...
        _c.execute("INSERT INTO notes values(?, ?, ?, ?)", (id.upper(), current_timestamp,
                   note_to_write, hashlib.sha1((id.upper() + current_timestamp).encode()).hexdigest()))
...
def image_upload_record(uid, owner, image_name, timestamp):
    with sqlite3.connect(image_db_file_location) as _conn:
        ...
        _c.execute("INSERT INTO images VALUES (?, ?, ?, ?)",
